...
public class Feedback
{
    ...
    public DateTimeOffset CreatedStressMeassurementDate { get; set; }

    public FeedbackDto AsDto()
    {
        return new FeedbackDto(
            Id, PatientId, AuthorId, StressMeasurementId, Comment, CreatedCommentDate, CreatedStressMeassurementDate
        );
    }
}
